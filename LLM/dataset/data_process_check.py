...
predicate_list = {"RobotNear", "On", "Holding", "Exists", "IsClean", "Active", "Closed", "Low", "High"}
...
dic_pred_obj['Active'] = ['Curtain', 'AC', 'TubeLight', 'HallLight']
dic_pred_obj['Closed'] = ['Curtain', 'AC', 'TubeLight', 'HallLight']
dic_pred_obj['Low'] = ['ACTemperature']
dic_pred_obj['High'] = ['ACTemperature']
