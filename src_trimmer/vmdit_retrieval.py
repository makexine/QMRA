...
def main(data_path,rewrite_path):
    ...
    args.passages='../knowledge_generate/knowledge_medium_100.jsonl'
    args.passages_embeddings="../robot_embeddings_0/*"
...
if __name__ == "__main__":
    data_path = '../robot_retr_result/medium_instr_goal.jsonl'
    rewrite_path= 'new_query/n_medium.jsonl'
